<%-- 
    Document   : ver
    Created on : Oct 28, 2020, 6:52:07 PM
    Author     : arodas
--%>
...
<html>
    ...
    <body>
        ...
        <div style="border: 1pt;" class="container-fluid">
            <h1>Roles</h1>
            <br/>
            <a type="button" class="btn btn-primary" href="RolesController?accion=crear"> Nuevo Rol</a>
            <hr/>
        </div>
            ...
            <table class="table table-striped table-dark " border="1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><%= rol.getEstado() %></td>
                        <td>
                            <a type="button" class="btn btn-info" href="RolesController?accion=editar&RolID=<%= rol.getRolID() %>">Editar</a>
                            <a type="button" class="btn btn-danger" href="RolesController?accion=eliminar&RolID=<%= rol.getRolID()%>">Eliminar</a>
                        </td>
                    </tr>
                </tbody>
