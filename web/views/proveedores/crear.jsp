    ...
    <!-- inicia el navbar -->
        ...
        <!-- Finaliza el navbar -->
              ...
              <div class="container">
                ...
                <br/>
                <form class="form-horizontal" widht="" heigth="" action="ProveedorController">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="xEmail" type="Email"  class="form-control" placeholder="Ingrese un Nombre de Usuario" required="" autofocus="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="xDireccion" type="text"  class="form-control" placeholder="Ingrese una Contraseña" required="" autofocus="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="xNit" type="Number" class="form-control" placeholder="Ingrese un Correo Electronico" required="">
                        </div>
                    </div>
