...
public class TiendaController extends HttpServlet {
    ...
    String list = "views/tiendas/ver.jsp";
    String add = "views/tiendas/crear.jsp";
    String edit = "views/tiendas/editar.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TiendaController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TiendaController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equalsIgnoreCase("listar")){
            ...
            String PorcentajeGanancia = request.getParameter("xPorcentajeGanancia");  
            tienda.setNombre(Nombre);
            tienda.setDireccion(Direccion);
            tienda.setPorcentajeGanancia(Double.parseDouble(PorcentajeGanancia));      
            dao.add(tienda);    
            access=list;
            ...
            Id = Integer.parseInt(request.getParameter("TiendaID"));
            tienda.setTiendaID(Id);
            dao.delete(Id);
            access=list;
        }
